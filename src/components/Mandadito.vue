<template>
  <v-container class="super-container">
    <v-container>
      <v-row dense>
                  ...
                  >
                    ...
                    <v-card>
                      ...
                      <v-container>
                        ...
                        <v-row
                          dense
                          v-if="destination.radioGroup === 'Tercero'"
                        >
                          <v-col>
                            <v-text-field
                              v-model="destination.thirdName"
                        ...
                        <li>
                          ...
                          <ul>
                            ...
                            <ul v-if="origin.radioGroup === 'Tercero'">
                              <li>
                                Nombre de Tercero: {{ origin.thirdPhone }}
                              </li>
